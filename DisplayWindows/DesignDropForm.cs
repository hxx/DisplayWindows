...
namespace DisplayWindows
{
    ...
    public partial class DesignDropForm : Form
    {
        #region 窗体实例
            ...
            if (e.Button == MouseButtons.Left)
            {
                switch (m_MousePointPosition)
                {
                    case EnumMousePointPosition.MouseDrag:
                        ...
                        DBOperateClass.Run_SQL("update drop_design_info set Control_Update = '1' where Control_Name = '" + lCtrl.Name + "'", mdconn);
                    ...
                    case EnumMousePointPosition.MouseSizeBottom:
                        ...
                        DBOperateClass.Run_SQL("update drop_design_info set Control_Update = '1' where Control_Name = '" + lCtrl.Name + "'", msbconn);
                        for (int i = 0; i < videoCount; i++)
                        {
                            if (videoPictureBox[i].Name == lCtrl.Name)
                            {
                    ...
                    case EnumMousePointPosition.MouseSizeBottomRight:
                        ...
                        DBOperateClass.Run_SQL("update drop_design_info set Control_Update = '1' where Control_Name = '" + lCtrl.Name + "'", msbrconn);
                        for (int i = 0; i < videoCount; i++)
                        {
                            if (videoPictureBox[i].Name == lCtrl.Name)
                            {
                    ...
                    case EnumMousePointPosition.MouseSizeRight:
                        ...
                        DBOperateClass.Run_SQL("update drop_design_info set Control_Update = '1' where Control_Name = '" + lCtrl.Name + "'", msrconn);
                        for (int i = 0; i < videoCount; i++)
                        {
                            if (videoPictureBox[i].Name == lCtrl.Name)
                            {
                    ...
                    case EnumMousePointPosition.MouseSizeTop:
                        ...
                        DBOperateClass.Run_SQL("update drop_design_info set Control_Update = '1' where Control_Name = '" + lCtrl.Name + "'", mstconn);
                        for (int i = 0; i < videoCount; i++)
                        {
                            if (videoPictureBox[i].Name == lCtrl.Name)
                            {
                    ...
                    case EnumMousePointPosition.MouseSizeLeft:
                        ...
                        DBOperateClass.Run_SQL("update drop_design_info set Control_Update = '1' where Control_Name = '" + lCtrl.Name + "'", mslconn);
                        for (int i = 0; i < videoCount; i++)
                        {
                            if (videoPictureBox[i].Name == lCtrl.Name)
                            {
                    ...
                    case EnumMousePointPosition.MouseSizeBottomLeft:
                        ...
                        DBOperateClass.Run_SQL("update drop_design_info set Control_Update = '1' where Control_Name = '" + lCtrl.Name + "'", msblconn);
                        for (int i = 0; i < videoCount; i++)
                        {
                            if (videoPictureBox[i].Name == lCtrl.Name)
                            {
                    ...
                    case EnumMousePointPosition.MouseSizeTopRight:
                        ...
                        DBOperateClass.Run_SQL("update drop_design_info set Control_Update = '1' where Control_Name = '" + lCtrl.Name + "'", mstrconn);
                        for (int i = 0; i < videoCount; i++)
                        {
                            if (videoPictureBox[i].Name == lCtrl.Name)
                            {
                    ...
                    case EnumMousePointPosition.MouseSizeTopLeft:
                        ...
                        DBOperateClass.Run_SQL("update drop_design_info set Control_Update = '1' where Control_Name = '" + lCtrl.Name + "'", mstlconn);
                        for (int i = 0; i < videoCount; i++)
                        {
                            if (videoPictureBox[i].Name == lCtrl.Name)
                            {
        ...
        #region 载入窗口
        private void DesignDropForm_Load(object sender, EventArgs e)
        {
            initProperty();
            #region 从数据库drop_desgin_info表里里读取控件信息
            ...
            for (int i = 0; i < dropdt.Rows.Count; i++)
            {
                if (dropdt.Rows[i]["Control_Type"].ToString() == "video")
                {
                    ...
                    videoPropertiesClass[videoCount].X = dropdt.Rows[i]["Control_X"].ToString();
                    videoPropertiesClass[videoCount].Y = dropdt.Rows[i]["Control_Y"].ToString();
                    videoPropertiesClass[videoCount].Width = dropdt.Rows[i]["Control_Width"].ToString();
                    videoPropertiesClass[videoCount].Height = dropdt.Rows[i]["Control_Height"].ToString();
                    videoPictureBox[videoCount].Name = dropdt.Rows[i]["Control_Name"].ToString();
                    ...
                    videoPictureBox[videoCount].Size = new System.Drawing.Size(int.Parse(dropdt.Rows[i]["Control_Width"].ToString()), int.Parse(dropdt.Rows[i]["Control_Height"].ToString())); //控件大小
                    ...
                    videoPictureBox[videoCount].ContextMenuStrip = this.videocontextMenuStrip_drop;   //增加鼠标右键菜单
            ...
            for (int i = 0; i < dropdt.Rows.Count; i++)
            {
                if (dropdt.Rows[i]["Control_Type"].ToString() == "drop")
                {
                    ...
                    dropPropertiesClass[dropCount].X = dropdt.Rows[i]["Control_X"].ToString();
                    dropPropertiesClass[dropCount].Y = dropdt.Rows[i]["Control_Y"].ToString();
                    dropPropertiesClass[dropCount].Width = dropdt.Rows[i]["Control_Width"].ToString();
                    dropPropertiesClass[dropCount].Height = dropdt.Rows[i]["Control_Height"].ToString();
                    dropPictureBox[dropCount].Name = dropdt.Rows[i]["Control_Name"].ToString();
                    ...
                    dropPictureBox[dropCount].Size = new System.Drawing.Size(int.Parse(dropdt.Rows[i]["Control_Width"].ToString()), int.Parse(dropdt.Rows[i]["Control_Height"].ToString())); //控件大小
                    ...
                    dropPictureBox[dropCount].ContextMenuStrip = this.dropcontextMenuStrip_drop;   //增加鼠标右键菜单
            ...
            if (toolForm.ToolControlsName != null)
            {
                switch (toolForm.ToolControlsName)
                {
                    ...
                    case "Video":
                        ...
                        MySqlDataAdapter Videoadapter = new MySqlDataAdapter("select * from drop_design_info", VideoConn);
                    ...
                    case "Drop":
                        ...
                        DBOperateClass.Run_SQL("insert into drop_design_info(Control_Name,Control_Type,Control_X,Control_Y,Control_Width,Control_Height,Control_Save,Control_Delete,Control_Update) value ('" + dropPictureBox[dropCount].Name + "','" + dropPropertiesClass[dropCount].Type + "','" + dropPictureBox[dropCount].Location.X.ToString() + "','" + dropPictureBox[dropCount].Location.Y.ToString() + "','" + dropPictureBox[dropCount].Size.Width.ToString() + "','" + dropPictureBox[dropCount].Size.Height.ToString() + "','" + dropPropertiesClass[dropCount].Save.ToString() + "','" + dropPropertiesClass[dropCount].Delete.ToString() + "','" + dropPropertiesClass[dropCount].Update.ToString() + "')", Droplocalconn);
                        #endregion
                    ...
                    case "Temp":
                        ...
                        tempPictureBox.ContextMenuStrip = this.videocontextMenuStrip_drop;    //增加鼠标右键菜单
        ...
        #region 设置右键菜单父控件
        private void videoContextMenuStrip_drop_Opening(object sender, CancelEventArgs e)
        {
            control = ((System.Windows.Forms.ContextMenuStrip)sender).SourceControl;
        }

        private void dropContextMenuStrip_drop_Opening(object sender, CancelEventArgs e)
        {
            control = ((System.Windows.Forms.ContextMenuStrip)sender).SourceControl;
        }
        #endregion
        ...
        #region 点击摄像头的属性
        private void video属性摄像头ToolStripMenuItem_drop_Click(object sender, EventArgs e)
        {
        ...
        #region 点击摄像头的删除
        private void video删除ToolStripMenuItem_drop_Click(object sender, EventArgs e)
        {
            ...
            DBOperateClass.Run_SQL("update drop_design_info set Control_Delete = '1' where Control_Name = '" + control.Name + "'", localconn);
            #endregion
            videoCount--;
            control.Dispose();
            need_Save = true; //将需要保存标识置为true
        ...
        #region 点击摄像头的设为顶层
        private void video设为顶层ToolStripMenuItem_drop_Click(object sender, EventArgs e)
        {
        ...
        #region 点击摄像头的设为底层
        private void video设为底层ToolStripMenuItem_drop_Click(object sender, EventArgs e)
        {
            control.SendToBack();
        }
        #endregion
        ...
        #region 点击水浸的属性
        private void drop属性水浸ToolStripMenuItem_drop_Click(object sender, EventArgs e)
        {
        ...
        #region 点击水浸的删除
        private void drop删除ToolStripMenuItem_drop_Click(object sender, EventArgs e)
        {
            #region 在数据库里将该记录的删除标记置为1
            string conn = "server=localhost;uid=root;Password=password;database=mg;charset=utf8";
            DBOperateClass.Run_SQL("update drop_design_info set Control_Delete = '1' where Control_Name = '" + control.Name + "'", conn);
        ...
        #region 点击水浸的设为顶层
        private void drop设为顶层ToolStripMenuItem_drop_Click(object sender, EventArgs e)
        {
            control.BringToFront();
        }
        #endregion
        ...
        #region 点击水浸的设为底层
        private void drop设为底层ToolStripMenuItem_drop_Click(object sender, EventArgs e)
        {
            control.SendToBack();
        }
        #endregion
        ...
        private void DesignDropForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (need_Save == true)
            {
                ...
                switch (mess)
                {
                    ...
                    case DialogResult.Yes:
                        ...
                        DBOperateClass.Run_SQL("update drop_design_info set Control_Save = '1'", yesconn);
                        #endregion
                        #region 保存按钮，将删除标记为1的控件删除
                        DBOperateClass.Run_SQL("delete from drop_design_info where Control_Delete = '1'", yesconn);
                        #endregion
                        #region 保存按钮，将更新标记为1的控件的信息重新保存
                        for (int i = 0; i < videoCount; i++)
                        {
                            DBOperateClass.Run_SQL("update drop_design_info set Control_X = '" + videoPropertiesClass[i].X + "',Control_Y = '" + videoPropertiesClass[i].Y + "',Control_Width = '" + videoPropertiesClass[i].Width + "',Control_Height = '" + videoPropertiesClass[i].Height + "' where (Control_Update = '1' and Control_Name = '" + videoPictureBox[i].Name + "') ", yesconn);
                        }
                        for (int i = 0; i < dropCount; i++)
                        {
                            DBOperateClass.Run_SQL("update drop_design_info set Control_X = '" + dropPropertiesClass[i].X + "',Control_Y = '" + dropPropertiesClass[i].Y + "',Control_Width = '" + dropPropertiesClass[i].Width + "',Control_Height = '" + dropPropertiesClass[i].Height + "' where (Control_Update = '1' and Control_Name = '" + dropPictureBox[i].Name + "') ", yesconn);
                        }

                        #region 将更新标记为1的重新置为0
                        DBOperateClass.Run_SQL("update drop_design_info set Control_Update = '0'", yesconn);
                        #endregion
                        #endregion
                        break;
                    #endregion
                    ...
                    case DialogResult.No:
                        ...
                        DBOperateClass.Run_SQL("delete from drop_design_info where Control_Save = '0'",
                            noconn);
                        #endregion
                        #region 不保存按钮，将删除控件的删除标记置为0
                        DBOperateClass.Run_SQL("update drop_design_info set Control_Delete = '0'", noconn);
                        #endregion
                        #region 不保存按钮，将更新标记为1的重新置为0
                        DBOperateClass.Run_SQL("update drop_design_info set Control_Update = '0'", noconn);
                        #endregion
                        break;
                    #endregion
